<template>
    <div :class="badgeClasses" :title="copyable ? (copied ? 'Copied!' : 'Click to copy value') : undefined"
        :role="copyable ? 'button' : undefined" :tabindex="copyable ? 0 : -1" @click="handleCopy"
        ...
        <span v-if="copyable && copied" class="text-[11px] font-semibold text-success ml-1">
            Copied
        </span>
    </div>
</template>
