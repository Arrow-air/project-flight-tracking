            ...
            <div class="flex items-start justify-between gap-3">
                <div class="space-y-1 text-sm">
                    <div class="flex flex-wrap gap-2 items-center">
                        ...
                        <span v-if="log.uploadedByName" class="text-base-content/70">Uploaded by {{ log.uploadedByName
                            }}</span>
                    </div>
                ...
                <div class="card-actions">
                    ...
                    <a class="btn btn-ghost btn-sm" :href="signedUrl" target="_blank" rel="noopener"
                        @click.prevent="openSigned">Open</a>
